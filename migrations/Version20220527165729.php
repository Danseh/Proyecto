 ...
 */
final class Version20220527165729 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP piso_id, CHANGE apellidos apellidos VARCHAR(50) DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE user ADD piso_id INT DEFAULT NULL, CHANGE apellidos apellidos VARCHAR(100) DEFAULT NULL');
