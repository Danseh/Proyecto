        ...
        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
            ...
            <form method="post" action={urlEditUser} onSubmit={handleSubmitPassword}>
              ...
              <div className="form-group">
                <input type="password" name="password" minlength="6" id="inputPassword" className="form-control" placeholder="Nueva contraseña" autoComplete="password" />
              </div>  

              <div className='form-guardar'>
                <input type="submit" value="Actualizar contraseña" className="btn btn-lg btn-success" />
              </div>
